...
if __name__ == '__main__':
    ...
    # subsubHwnd = win32gui.FindWindowEx(subHwnd, 0, 'Afx:00007FF6E0E40000:8', None)
    # print('子子窗口句柄：{:08X}'.format(subsubHwnd))
    hwndChildList = []
    win32gui.EnumChildWindows(subHwnd, lambda hwnd, param: param.append(hwnd), hwndChildList)
    subsubHwnd=hwndChildList[0]
